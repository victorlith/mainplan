...
namespace Projeto_M.Class01
{
    internal class LogsDoSistema
    {
        ...
        private string path = @"C:\Users\Public\Documents\Menplan Industrial Service\Logs";
        ...
        public void Log_Funcionarios(string atividade, string usuarioSistema, string usuario)
        {
            ...
            string textoCadastro = $"{dataEvento} > Usuário:[{usuarioSistema}] cadastrou o usuário {usuario}. \n";
