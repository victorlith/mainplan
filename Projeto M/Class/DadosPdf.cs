...
namespace Projeto_M.Class01
{
    class DadosPdf
    {
        ...
        public string[] DadosCliente()
        {
            ...
            return new[] { cep, lorgradouro, numeroEndereco, complemento, bairro, cidade, uf, razaoSocial, nomeEmpresa, email, cnpj };
        }
        ...
        public string[] DadosServico()
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    telefoneCliente = (string)dr["n_contato"]; //ID8
                    email = (string)dr["n_email"];
                }
                dr.Close();
            ...
            return new[] { dataSolicitacao, descricao, codEquipamento, responsavel, area, equipamento, solicitacao, solicitante, telefoneCliente, email };
        }
    }
}
